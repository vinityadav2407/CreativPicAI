...
const Navbar = () => {
  ...
  let nevigate=useNavigate();
   let {user ,setShowLogin,logout,credit}=useContext(AppContext);
       ...
       <div>
         ...
         user ?
          ...
          <div className='flex items-center gap-2 sm:gap-6'>
           ...
           <button onClick={()=>(setShowLogin(true))} className='bg-zinc-800 text-white  text-sm py-2 px-7 sm:px-10 rounded-full'>Login</button>
          </div>
        }
